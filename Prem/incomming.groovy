...
def SetStatus(){
    ...
    def statusMappingStory = [
        "Backlog":"Backlog",
        "Select For Development":"Select For Dev",
        "In Progress":"In Progress",
        "Done":"Done"
    ]
...
//Custom Fields 
// Local CF<>Remote CF
issue.customFields."Color".value = replica.customFields."Color"?.value?.value ?: "Red"
issue.customFields."J_Status".value = replica.status.name
